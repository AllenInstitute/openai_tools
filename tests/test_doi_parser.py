...
def test_nature_doi_pdf():
    ...
    assert doi_parser.get_pdf_link() == 'http://www.nature.com/articles/nature12373.pdf'

def test_biorxiv1_doi_pdf():
    doi_parser = DoiParser('10.1101/2020.03.03.972133')
    assert doi_parser.get_pdf_link() == 'https://www.biorxiv.org/content/10.1101/2020.03.03.972133v1.full.pdf'

def test_biorxiv2_doi_pdf():
    doi_parser = DoiParser('10.1101/2020.10.15.341602')
    assert doi_parser.get_pdf_link() == 'https://www.biorxiv.org/content/10.1101/2020.10.15.341602v2.full.pdf'

def test_cell_doi_pdf():
    doi_parser = DoiParser('10.1016/j.celrep.2023.112434')
    assert doi_parser.get_pdf_link() == None

def test_title_doi_pdf():
    doi_parser = DoiParser('10.1101/2020.03.03.972133')
    assert doi_parser.get_title() == 'AI-aided design of novel targeted covalent inhibitors against SARS-CoV-2'
